...
import { confirmStripeBySession } from "@/infrastructure/payments/confirm";

export const dynamic = "force-dynamic";

/** Where Stripe redirects after Checkout. Verifies the session server-side,
 *  marks the order paid, and forwards to the order page. */
export default async function StripeCallbackPage({
  ...
  if (session_id) {
    const res = await confirmStripeBySession(session_id);
